# ShowHide
##A container that shows or hides master visualizations based on IF conditions. These IF conditions that control which visualization are shown could be based on:
...
##Examples:
###User accessing the chart: 
![alt tag](https://github.com/fadyheiba/ShowHide/blob/master/FEI-ShowHide/ShowHide-Users.gif)
###Variables for real estate:  
