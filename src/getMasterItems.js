define(['qlik'], function (qlik) {
    ...
    var masterObjectPromise, masterobjects;
    return function () {
        var app = qlik.currApp();
        if (!masterObjectPromise) {
            masterObjectPromise = app.getList('masterobject').then(function (model) {
                ...
                masterobjects = model.layout.qAppObjectList.qItems.filter(function (item) {
