define(['./get-master-items'], function (getMasterItems) {
  ...
  var aboutDefinition = {
    ...
    items: {
      ...
      paragraph1: {
        label: `A container object that can contain several master visualizations. The app developer
          defines expressions that control which object that is displayed.`,
        component: 'text'
      },
      paragraph2: {
        label: `Show/hide container is based upon an extension created by Fady Heiba at
